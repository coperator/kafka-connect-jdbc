 ...
 */
public class CustomSqlServerDatabaseDialect extends GenericDatabaseDialect {

  private static final Logger log = LoggerFactory.getLogger(CustomSqlServerDatabaseDialect.class);
  ...
  /**
   * The provider for {@link CustomSqlServerDatabaseDialect}.
   */
  public static class Provider extends SubprotocolBasedProvider {
    public Provider() {
      super(CustomSqlServerDatabaseDialect.class.getSimpleName(),
    ...
    public DatabaseDialect create(AbstractConfig config) {
      return new CustomSqlServerDatabaseDialect(config);
    }
  }
   ...
   */
  public CustomSqlServerDatabaseDialect(AbstractConfig config) {
